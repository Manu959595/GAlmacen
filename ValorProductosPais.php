			...
			// --- --- --- --- --- --- --- --- --- --- --- ---
               ...
               while ($registro = mysqli_fetch_row($resultado)){
                  ...
                  echo '    <td colspan="4">';
                    ...
                    // Cosulta todos los productos de ese pais
                    $consultaproductospais="select nombre, precio, stock, precio*stock as valor, foto from productos where pais_procedencia='$registro[0]'";
                 ...
                 echo "</tr>";
                 // Recorremos $resultado mostrando cada fila de la tabla
                 while ($reg = mysqli_fetch_row(result: $R)){
