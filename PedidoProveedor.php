		...
		<div class="row text-center h-70">	
          <div class="container  h-100">
			<div class="text-center mx-auto col-10">		
               ...
               $tabla="catalogo";// Escribir entre comillas el nombre de la tabla a listar
			...
			<div class="text-center mx-auto col-10">	
               ...
               //--------------------------------------------------------------------------------------------------
                ...
                // --- --- --- --- --- --- --- --- --- --- --- ---
                    ...
                    echo '	  <a class="page-link" href="PedidoProveedor.php?pagina='.$anterior.'">&laquo;</a>';
                    echo '	</li>';
                    for ($i=1;$i<=$numpag;$i++)
                    {
                        if($i==$pagina){
                                echo '	<li class="page-item active">';
                                echo '	  <a class="page-link"href="PedidoProveedor.php?pagina='.$i.'">'.$i.'</a>';
                                echo '	</li>';						
                            }
                            else{
                                echo '	<li class="page-item"><a class="page-link" href="PedidoProveedor.php?pagina='.$i.'">'.$i.'</a></li>';
                            }
                    }
                    echo '	<li class="page-item ">';
                    echo '	  <a class="page-link" href="PedidoProveedor.php?pagina='.$siguiente.'">&raquo;</a>';
                    echo '	</li>';
                    echo '  </ul>';
